...
This project is indexed by GitNexus as **pindrop** (612 symbols, 599 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
