...
final class AIModelService {
    ...
    private func fetchAnthropicModels() -> [AIModel] {
        [
            ...
            AIModel(id: "claude-sonnet-4-6-20250514", name: "Claude Sonnet 4.6", provider: .anthropic,
                    description: "Balanced performance", contextLength: 200_000),
            AIModel(id: "claude-opus-4-6-20250514", name: "Claude Opus 4.6", provider: .anthropic,
